		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#nestedcomponentstest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nestedcomponentstest-display": {
								"semanticObject": "nestedcomponentstest",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nestedcomponentstest",
									"url": sap.ui.require.toUrl("nestedcomponentstest")
								}
							}
						}
					}
